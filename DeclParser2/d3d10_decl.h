...
MIDL_INTERFACE("9B7E4C0F-342C-4106-A19F-4F2704F689F0")
    ...
    public:
        ...
        virtual void STDMETHODCALLTYPE RSGetViewports( 
            __inout_range(0, D3D10_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE )   UINT *NumViewports,
            __out_ecount_opt(*NumViewports)  D3D10_VIEWPORT *pViewports) = 0;
        
        virtual void STDMETHODCALLTYPE RSGetScissorRects( 
            __inout_range(0, D3D10_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE )   UINT *NumRects,
            __out_ecount_opt(*NumRects)  D3D10_RECT *pRects) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetDeviceRemovedReason( void) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE SetExceptionMode( 
            __in UINT RaiseFlags) = 0;
