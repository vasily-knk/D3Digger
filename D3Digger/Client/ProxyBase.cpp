...
HRESULT ProxyBase<IDirect3DDevice9>::SetCursorProperties(UINT XHotSpot, UINT YHotSpot, IDirect3DSurface9* pCursorBitmap)
{
    ...
    wp(XHotSpot);
    wp(YHotSpot);
    wp(pCursorBitmap ? dynamic_cast<IProxy<IDirect3DSurface9>*>(pCursorBitmap)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::UpdateSurface(IDirect3DSurface9* pSourceSurface, const RECT* pSourceRect, IDirect3DSurface9* pDestinationSurface, const POINT* pDestPoint)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pSourceSurface ? dynamic_cast<IProxy<IDirect3DSurface9>*>(pSourceSurface)->getId() : ProxyId(0));
    wp(ptr2opt(pSourceRect));
    wp(pDestinationSurface ? dynamic_cast<IProxy<IDirect3DSurface9>*>(pDestinationSurface)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::UpdateTexture(IDirect3DBaseTexture9* pSourceTexture, IDirect3DBaseTexture9* pDestinationTexture)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pSourceTexture ? dynamic_cast<IProxy<IDirect3DBaseTexture9>*>(pSourceTexture)->getId() : ProxyId(0));
    wp(pDestinationTexture ? dynamic_cast<IProxy<IDirect3DBaseTexture9>*>(pDestinationTexture)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::GetRenderTargetData(IDirect3DSurface9* pRenderTarget, IDirect3DSurface9* pDestSurface)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pRenderTarget ? dynamic_cast<IProxy<IDirect3DSurface9>*>(pRenderTarget)->getId() : ProxyId(0));
    wp(pDestSurface ? dynamic_cast<IProxy<IDirect3DSurface9>*>(pDestSurface)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::ColorFill(IDirect3DSurface9* pSurface, const RECT* pRect, D3DCOLOR color)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pSurface ? dynamic_cast<IProxy<IDirect3DSurface9>*>(pSurface)->getId() : ProxyId(0));
    wp(ptr2opt(pRect));
    wp(color);
...
HRESULT ProxyBase<IDirect3DDevice9>::SetDepthStencilSurface(IDirect3DSurface9* pNewZStencil)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pNewZStencil ? dynamic_cast<IProxy<IDirect3DSurface9>*>(pNewZStencil)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::SetTexture(DWORD Stage, IDirect3DBaseTexture9* pTexture)
{
    ...
    wp(getId());
    wp(Stage);
    wp(pTexture ? dynamic_cast<IProxy<IDirect3DBaseTexture9>*>(pTexture)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::ProcessVertices(UINT SrcStartIndex, UINT DestIndex, UINT VertexCount, IDirect3DVertexBuffer9* pDestBuffer, IDirect3DVertexDeclaration9* pVertexDecl, DWORD Flags)
{
    ...
    wp(DestIndex);
    wp(VertexCount);
    wp(pDestBuffer ? dynamic_cast<IProxy<IDirect3DVertexBuffer9>*>(pDestBuffer)->getId() : ProxyId(0));
    wp(pVertexDecl ? dynamic_cast<IProxy<IDirect3DVertexDeclaration9>*>(pVertexDecl)->getId() : ProxyId(0));
    wp(Flags);
...
HRESULT ProxyBase<IDirect3DDevice9>::SetVertexDeclaration(IDirect3DVertexDeclaration9* pDecl)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pDecl ? dynamic_cast<IProxy<IDirect3DVertexDeclaration9>*>(pDecl)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::SetVertexShader(IDirect3DVertexShader9* pShader)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pShader ? dynamic_cast<IProxy<IDirect3DVertexShader9>*>(pShader)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::SetStreamSource(UINT StreamNumber, IDirect3DVertexBuffer9* pStreamData, UINT OffsetInBytes, UINT Stride)
{
    ...
    wp(getId());
    wp(StreamNumber);
    wp(pStreamData ? dynamic_cast<IProxy<IDirect3DVertexBuffer9>*>(pStreamData)->getId() : ProxyId(0));
    wp(OffsetInBytes);
    wp(Stride);
...
HRESULT ProxyBase<IDirect3DDevice9>::SetIndices(IDirect3DIndexBuffer9* pIndexData)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pIndexData ? dynamic_cast<IProxy<IDirect3DIndexBuffer9>*>(pIndexData)->getId() : ProxyId(0));
...
HRESULT ProxyBase<IDirect3DDevice9>::SetPixelShader(IDirect3DPixelShader9* pShader)
{
    ...
    bytes::write_proc wp(inBytes);
    wp(getId());
    wp(pShader ? dynamic_cast<IProxy<IDirect3DPixelShader9>*>(pShader)->getId() : ProxyId(0));
